...
"""
Enterprise Base Settings for myrocket
...
"""
Django settings for myrocket project.
...
SECRET_KEY = 'django-insecure-n@u&-sm570e$*wcq^0h4x0_%zwx^%uf!)h^p&%v%p82b%=pr)a'
...
WSGI_APPLICATION = 'myrocket.wsgi.application'
